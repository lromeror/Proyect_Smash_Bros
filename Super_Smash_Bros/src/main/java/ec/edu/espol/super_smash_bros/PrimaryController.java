...
//                        new Move("Supersalto puñetazo",TipoMovimiento.UP, "/data/mario/up.jpg"),
//                        new Move("F.L.U.D.D",TipoMovimiento.DOWN, "/data/mario/down.jpg")};
//                    Personaje pito = new Personaje("Mario",movimientos,new Move("Mario final",TipoMovimiento.FO, "/data/mario/final.jpg"), "mario.jpg","El plomero favorito de todos es un personaje equilibrado que está listo para enfrenta cualquier situación.");
//                    Image img = new Image(pito.getImagen());
//                    ImageView imgV = new ImageView(img);
//                    Tarjeta boton = new Tarjeta(pito);
//                    boton.getChildren().add(imgV);
//                    boton.addEventHandler(MouseEvent.MOUSE_CLICKED, (Event t) -> {
//                        Personaje p = boton.getPersonaje();
//                        data.setPersonaje(p);
//                        try {
//                            SessionManager.getInstance().setPersonaje(pito);
//                            switchToSecondary();
//                        } catch (IOException ex) {
//                            ex.printStackTrace();
//                        }
